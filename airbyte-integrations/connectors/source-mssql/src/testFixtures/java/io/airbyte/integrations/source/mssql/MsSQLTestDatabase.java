...
public class MsSQLTestDatabase extends TestDatabase<MSSQLServerContainer<?>, MsSQLTestDatabase, MsSQLTestDatabase.MsSQLConfigBuilder> {
  ...
  public enum ContainerModifier {
    ...
    NETWORK("withNetwork"),
    AGENT("withAgent"),
    WITH_SSL_CERTIFICATES("withSslCertificates", MsSQLTestDatabase::initWithSsl),
    ;
    ...
    ContainerModifier(final String methodName, Consumer<MsSQLTestDatabase> databaseModifier) {
